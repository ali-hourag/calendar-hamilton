...
function setCalendarContainer(): void {
    ...
    const historyEventsContainerDiv: (HTMLDivElement) = document.createElement("div");
...
function setEntryDaysCalendar(){
    ...
    for(let i = 1; i <= 42; i++){
        ...
        const entryDayEventsContainer: (HTMLDivElement | null) = document.createElement("div");
        ...
        if(entryDayEventsContainer === null) return;
