...
function setModalInfoEvent() {
    ...
    const modalHeaderBtn = document.createElement("button");
    const modalBodyContainerDiv = document.createElement("div");
    const modalBodyTitleH2 = document.createElement("h2");
    const modalBodyInitialDiv = document.createElement("div");
    const modalBodyInitialP1 = document.createElement("p");
    const modalBodyInitialP2 = document.createElement("p");
    const modalBodyEndDiv = document.createElement("div");
    const modalBodyEndP1 = document.createElement("p");
    const modalBodyEndP2 = document.createElement("p");
    const modalBodyReminderDiv = document.createElement("div");
    const modalBodyReminderP = document.createElement("p");
    const modalBodyDescriptionDiv = document.createElement("div");
    const modalBodyDescriptionP1 = document.createElement("p");
    const modalBodyDescriptionTArea = document.createElement("textarea");
    const modalBodyDescriptionP2 = document.createElement("p");
    const modalFooterContainerDiv = document.createElement("div");
    const modalFooterCancelBtn = document.createElement("button");
    if (main === null)
        return;
    let classInfoModal = "d-flex flex-row justify-content-between align-items-center";
